...
Route::middleware('guest')->group(function () {
    Route::get('employer/register', [RegisteredEmployerController::class, 'create'])->name('employer.register');
    Route::post('employer/register', [RegisteredEmployerController::class, 'store']);

    Route::get('seeker/register', [RegisteredSeekerController::class, 'create'])->name('seeker.register');
    Route::post('seeker/register', [RegisteredSeekerController::class, 'store']);
